...
from orange_cb_recsys.recsys import CentroidVectorRecommender, ClassifierRecommender, NXPageRank, IndexQuery
...
runnable_instances = {
    ...
    "centroid_vector": CentroidVectorRecommender,
